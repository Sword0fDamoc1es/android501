...
public class TMDBMovie extends ApiEvent implements Serializable {
    private String id;
    private String name;
    ...
    public TMDBMovie(String id, String name, String description, String release_date, String poster_path) {
        this.id = id;
        this.name = name;
